(function ($) {
  ...
  var windowOn = $(window);
    ...
    /*-----------------------------------------------------------------------------------
        ...
        Author: BINARIZE
        Support: https://www.binarizeweb.com/
        Description: Immigration and Visa Consulting HTML5 Template
        Version: 1.0
        Developer: Danushka Bandara (https://danushkabandara.com/)
    ...
    iframe: {
      patterns: {
        youtube: {
          ...
          src: 'https://www.youtube.com/embed/%id%?autoplay=1&mute=1&rel=0&showinfo=0&controls=1'
        }
      }
    },
    callbacks: {
      open: function() {
        // Video will start playing automatically due to autoplay=1 parameter
      }
    }
  });
