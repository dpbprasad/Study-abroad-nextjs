...
export default function BlogCard({ blog, delay = '.2s' }: BlogCardProps) {
  return (
    <div className="blog__content">
      ...
      <div className="blog__content-text mt-20">
        <h2 className="blog__content-text-title wow fadeInLeft animated" data-wow-delay={delay}>
          <Link href={`/blog/${blog.slug}`}>{blog.title}</Link>
        </h2>
        <p className="wow fadeInLeft animated" data-wow-delay=".8s">{blog.excerpt}</p>
        <Link href={`/blog/${blog.slug}`} className="rr-btn mt-40 wow fadeInLeft animated" data-wow-delay="1s">
          Learn More
