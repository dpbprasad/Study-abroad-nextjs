...
export default function ContactSection() {
  ...
  return (
    <section className="contact-us__area border bg-gray section-space-top section-space-bottom bottom custom-width overflow-hidden">
          ...
          <div className="col-lg-6">
            <div className="contact-us__title-wrapper">
              <div className="section__title-wrapper mb-40">
                ...
                <h2 className="section__title-wrapper-title wow fadeInLeft animated" data-wow-delay=".3s">Let Your Wanderlust Guide You</h2>
              </div>
              ...
              <div className="contact-us__form-wrapper white-bg">
                <form className="contact-us__form" onSubmit={handleSubmit}>
                  <div className="row">
                    ...
                    <div className="col-12">
                      <button type="submit" className="contact-btn mt-30 wow fadeInLeft animated" data-wow-delay=".8s">Send Message</button>
                    </div>
                  </div>
                </form>
              </div>
