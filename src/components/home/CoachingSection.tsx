...
export default function CoachingSection() {
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      if (typeof window !== 'undefined' && document.querySelector('.card-slide')) {
          ...
          <div className="col-12">
            <div className="section-slider-title-2 mb-60">
              <div className="section-slider-title-2-wrapper">
                <h6 className="section-slider-title-2-wrapper-subtitle wow fadeInLeft animated" data-wow-delay=".2s">
                ...
                <h2 className="section-slider-title-2-wrapper-title wow fadeInLeft animated" data-wow-delay=".3s">
                  Coaching That Opens Doors to <br /> Global Education
                </h2>
              </div>
              <div className="section-slider-title-2-button d-flex align-items-center">
