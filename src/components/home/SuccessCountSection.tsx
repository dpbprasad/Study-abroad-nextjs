...
/**
 * SuccessCountSection Component - REFACTORED VERSION
 *
 * Displays success metrics with animated counters and a CTA box.
 * Refactored to use new layout and UI components with cleaner structure.
 */
...
export default function SuccessCountSection({ grayBg = true, noTopPadding = false }: SuccessCountSectionProps) {
  ...
  const counters = [
    { ref: counter1Ref, label: 'Complete project' },
    { ref: counter2Ref, label: 'Team member' },
    { ref: counter3Ref, label: 'Winning award' },
    { ref: counter4Ref, label: 'Complete project' },
  ];

  return (
    <Section
      variant={grayBg ? 'gray' : 'default'}
      spacing={noTopPadding ? 'none' : 'lg'}
      className="overflow-hidden"
    >
      <Container>
        <Grid cols={{ xs: 1, md: 12 }} gap={6}>
          ...
          <div className="md:col-span-8">
            <Stack direction="vertical" spacing={6}>
              ...
              <Card variant="elevated" padding="none" className="overflow-hidden">
                <div className="flex flex-col md:flex-row">
                  ...
                  <div className="flex-1 p-6 md:p-8">
                    <div className="w-16 h-16 bg-[#00AF5B] rounded-full flex items-center justify-center mb-6">
                    ...
                    <Heading level="h2" size="xl" marginBottom="md">
              ...
              {/* Counter Stats */}
              <Card variant="elevated" padding="lg" className="counter-bg">
                <Grid cols={{ xs: 2, sm: 2, md: 4 }} gap={4}>
                  {counters.map((counter, index) => (
                    <div key={index} className="text-center">
                      ...
                      <p className="text-gray-600 text-sm">{counter.label}</p>
                    </div>
                  ))}
                </Grid>
              </Card>
